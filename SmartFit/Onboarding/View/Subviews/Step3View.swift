...
final class Step3View: UIView {
    
    private let values = Array(35...150)
    ...
    private func setup() {
        ...
        DispatchQueue.main.async {
            let index = self.values.firstIndex(of: 70) ?? 0
...
extension Step3View: UIPickerViewDataSource, UIPickerViewDelegate {
...
extension Step3View: OnboardingStep {
    func getData() -> Any {
        Step3Data(weight: selectedWeight)
    }
}
